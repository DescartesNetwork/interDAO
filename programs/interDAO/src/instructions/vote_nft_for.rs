...
pub fn exec(ctx: Context<VoteNftFor>, index: u64, tax: u64, revenue: u64) -> Result<()> {
  ...
  token::transfer(transfer_ctx, amount_nft)?;
  // Count the votes
  proposal
    .vote_for(amount_nft, receipt)
